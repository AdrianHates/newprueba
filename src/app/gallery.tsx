        ...
        `}
          ...
          <div className="flex flex-col border px-2 font-normal">
            ...
            <p className="w-28 flex justify-between">
              1 x <span className="text-[#1b5c5b] font-semibold">$35,000</span>
            </p>
            <p className="w-28 flex justify-between">
              3 x <span className="text-[#1b5c5b] font-semibold">$99,900</span>
            </p>
            <p className="w-28 flex justify-between">
              6 x <span className="text-[#1b5c5b] font-semibold">$180,000</span>
            </p>
            <p className="w-28 flex justify-between">
              12 x<span className="text-[#1b5c5b] font-semibold">$299,900</span>
            </p>
          </div>
        </div>
        <button
